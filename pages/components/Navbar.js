        ...
        <div className="container mx-auto nav_wrapper">
          ...
          <div className="nav_content hidden lg:block">
            <ul>
              ...
              <li className="relative inline-flex px-4 py-1 text-sm text-gray-900 font-semibold rounded-full border border-white bg-white hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 transition ease-in-out duration-150">
