...
export default function Homepage() {
  return (
    <>
      <header className="container-fluid classforheaderbg w-full flex md:place-items-center relative">
        <div className="container mx-auto p-5 md:p-0">
          <div className="headerContent flex flex-col justify-start items-start">
            <h1 className="text-white font-bold text-4xl md:text-6xl mondafont ">
              Darksoul Official Guild
            </h1>
            <p className="text-gray-200 md:w-2/4 max-w-full py-5 md:text-justify">
              Guilds are one of the most popular features of Garena Free Fire.
              The famous battle royale game allows players to join or create a
              guild. Players can also participate in guild tournaments and earn
              various rewards by collecting Dog Tags. They can also redeem and
              purchase a variety of items using Guild Tokens
            </p>
      ...
      <section className="w-full h-screen relative">
        <img
          className="absolute left-0 top-0 w-full max-w-full h-auto opacity-50"
